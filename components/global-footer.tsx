export const GlobalFooter = () => {
  return (<div className=" su-cc su-global-footer su-basefont-20 su-rs-py-1 su-text-white su-bg-cardinal-red ">
          ...
          <ul
            ...
            <li className="sm:su-mr-10 md:su-mr-20 lg:su-mr-27">
              <a href="https://www.stanford.edu"
                 className=" su-text-white su-no-underline hocus:su-underline hocus:su-text-white "> Stanford Home <span
          ...
          <ul
            ...
            <li className="sm:su-mr-10 md:su-mr-20 lg:su-mr-27">
              <a href="https://www.stanford.edu/site/terms/" title="Terms of use for sites"
                 className=" su-text-white su-no-underline hocus:su-underline hocus:su-text-white "> Terms of Use <span
                className="su-sr-only">(link is external)</span>
              </a>
            </li>
            <li className="sm:su-mr-10 md:su-mr-20 lg:su-mr-27">
