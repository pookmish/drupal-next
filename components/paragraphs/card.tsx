  ...
  return (
    <div
      ...
      {imageUrl &&
          <div className="su-aspect-w-2 su-aspect-h-1" aria-hidden="true">
              <DrupalImage
                  ...
                  src={imageUrl}
                  alt={su_card_media.field_media_image.resourceIdObjMeta.alt}
                  height={su_card_media.field_media_image.resourceIdObjMeta.height}
                  width={su_card_media.field_media_image.resourceIdObjMeta.width}
              />
          </div>
      }
      ...
      <div className="su-flex su-flex-col card-body su-items-start su-rs-px-2 su-rs-pt-2 su-rs-pb-4">
        ...
        {su_card_link &&
            <DrupalLink href={su_card_link.url}
