    ...
    <div className="hero su-basefont-23 su-relative su-h-full su-max-h-500">
      {su_banner_image &&
          <div className="su-h-full su-w-full su-overflow-hidden su-relative su-max-h-500">
              <img className="su-h-full su-w-full su-object-cover su-object-center"
                   src="https://placekitten.com/1000/750" alt=""/>
          </div>
      }
      <div
        ...
        <div className="su-flex su-flex-col card-body su-items-start su-rs-px-2 su-rs-pt-2 su-rs-pb-4">
          {su_banner_sup_header &&
              <span className="su-type-0 su-mb-0 su-leading-display su-font-bold">{su_banner_sup_header}</span>}
          {su_banner_header &&
              <h3 className="su-leading-display su-font-sans su-font-bold su-type-2 su-mb-03em">
                {su_banner_header}
              </h3>
          }
          {su_banner_body && <div><BasicHtml html={su_banner_body.processed}/></div>}
          {su_banner_button &&
              <DrupalLink href={su_banner_button.uri}
